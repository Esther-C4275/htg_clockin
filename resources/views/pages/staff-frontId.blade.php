<x-layout>
    ...
    * {
    ...
    @media (max-width: 768px) {
      ...
      .footer-nav {
        display: none; /* Simplify UI viewports for standard phone scales */
      }
      .main-viewport {
        padding: 24px;
      }
            ...
            <section class="badge-preview-column">
              <div class="badge-card">
                <div class="badge-banner">
                  <i><img class="gala-img" src="/images/icon.png" alt=""></i>
                ...
                <div class="badge-avatar" style="display: flex; align-items: center; justify-content: center; background-color: #E2E8F0; color: #2D3748; font-size: 36px; font-weight: 700; border: 5px solid #FFFFFF; overflow:hidden">
                  @if($user->avatar)
                  <img src="{{ asset('storage/' . $user->avatar) }}" alt="ID Photo" style="width: 100%; height: 100%; object-fit: cover;">
              @else
                  {{ $initials }}
              @endif
                </div>
                ...
                <div class="badge-metadata">
                  <div class="meta-row"><span class="meta-label">Company:</span> <span class="meta-value">{{ $user->company }}</span></div>
                  <div class="meta-row"><span class="meta-label">Phone:</span> <span class="meta-value">{{ $user->phone }}</span></div>
                  <div class="meta-row"><span class="meta-label">Email:</span> <span class="meta-value">{{ $user->email }}</span></div>
                </div>
            ...
            <section class="badge-details-column">
              ...
              <div class="protocol-banner">
                <div class="banner-icon">
                  <i><img src="/images/protocol.png" alt=""></i>
                </div>
              ...
              <div class="actions-wrapper">
                <button class="btn-print">
                  <i><img src="/images/Group 107.png" alt=""></i> Print Card
                </button>
              </div>
