    ...
    <style>
        * {
        ...
        .input-wrapper input {
          width: 100%;
          padding: 16px 20px;
          background-color: #ECECEC; /* Light grey block style inputs */
          border: none;
          border-radius: 25px; /* Fully rounded capsule input elements */
          font-size: 0.95rem;
          font-family: inherit;
          color: #222222;
          outline: none;
                ...
                <form action="{{ route('login.authenticate') }}" method="POST">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-wrapper">
                      <span class="input-icon left-icon"><li><img src="/images/Frame 113.png" alt=""></li></span>
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-wrapper">
                      ...
                      <span class="input-icon right-icon"><i><img src="/images/Frame 112.png" alt=""></i></span>
                    </div>
                  </div>
                  ...
                  <div class="form-options">
                    ...
                    <a href="{{ route('password.request') }}" style="text-decoration: none; font-weight: 700; color: black;">Forgot Password</a>
                  </div>
