...
<head>
    ...
    <title>{{ config('app.name', 'HTG PORTAL') }}</title>
    <link rel="manifest" href="{{ asset('manifest.json') }}">

    <meta name="theme-color" content="#06414F">
    ...
    <link rel="apple-touch-icon" href="{{ asset('images/master-logo.png') }}?v=5">
    <link rel="icon" type="image/png" href="{{ asset('images/master-logo.png') }}?v=5">
